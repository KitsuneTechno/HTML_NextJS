            ...
            
            {
                isOpen && (
                    <div className="flex flex-col-reverse justify-between basis-full items-center py-3 bg-gray-100">
                        <ul>
                            <li 
                            className="text-slm sm:text-sm transition ease-in-out hover:bg-orange-600 rounded duration-200">
                                <Link href={"/chatbot"}>Chatbot</Link></li>
                            <li 
                            className="text-slm sm:text-sm transition ease-in-out hover:bg-orange-600 rounded duration-200">
                                <Link href={"/mecanicas"}>Mecânicas</Link></li>
                            ...
                            className="text-slm sm:text-sm transition ease-in-out hover:bg-orange-600 rounded duration-200">
                                <Link href={"/membros"}>Membros</Link></li>
                            <li className="text-slm sm:text-sm transition ease-in-out hover:bg-orange-600 rounded duration-200"><Link href={"/cliente"}>Área do Cliente</Link></li>
                        </ul>
                    </div>
                )
            }
